...
def run(label, cmd):
 ...
 (out/'v106_results.json').write_text(json.dumps(results,ensure_ascii=False,indent=2))
names=[
 ...
 'validate_v106_separate_min_edge.py','validate_balance_js.py','validate_focus_js.py']
